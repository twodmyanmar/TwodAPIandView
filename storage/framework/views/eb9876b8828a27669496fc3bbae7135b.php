    ...
    <div class="bg-[#feed3b]  h-16 pt-3">
        <div class="flex justify-between align-items-center">
            ...
            <div class="flex justify-center align-items-center">
                <a href="#"><img src="public/assets/image/2d.png" class="mr-3 h-7 w-7" /></a>
                <a href="live3"><img src="public/assets/image/3D.png" class="mr-3 h-7 w-7" /></a>
...
<script type="text/javascript">
    var apiUrl = "https://www.twodthailandmyanmar.com/api/live";
    ...
    const fetchData = () => {
        ...
        const apiUrl = "https://www.twodthailandmyanmar.com/api/live";
        fetch(apiUrl,{
                method: 'GET',
                headers: {
            ...
            .then((data) => {
                ...
                set0.innerHTML = data.result[1].set.replace(",",'.');
                value0.innerHTML = data.result[1].value.replace(",",'.').replace(",",'.');
                twod0.innerHTML = data.result[1].twod;

                set0.style.color = "white";
                value0.style.color = "white";
                // twod2.style.color = "white";

                set2.innerHTML = data.result[3].set.replace(",",'.');
                value2.innerHTML = data.result[3].value.replace(",",'.');
                twod2.innerHTML = data.result[3].twod;
                ...
                if (currentHour < 12) {
                    ...
                    document.getElementById('set0').innerHTML = data.result[1].set.replace(",",'.');
                    document.getElementById('value0').innerHTML = data.result[1].value.replace(",",'.');
                    document.getElementById('twod0').innerHTML = data.result[1].twod;
                ...
                } else if (currentMinutes < 30 && currentHour == 16 ){
                    liveNumber.innerHTML = data.live.twod;
                    liveNumber.style.textShadow = "2px 2px 4px #ffffff";
                    liveNumber.style.color = "#30ad42";
                    document.getElementById('set2').innerHTML = data.live.set.replace(",",'.');
                    ...
                    const status = data.result[3].status;
                    if(status != "1")
                    {
                        mark.style.display = "block";
                        clock.style.display = "none";
                    ...
                    liveNumber.innerHTML = data.result[3].twod;
                    document.getElementById('set2').innerHTML = data.result[3].set.replace(",",'.');
                    document.getElementById('value2').innerHTML = data.result[3].value.replace(",",'.');
                    document.getElementById('twod2').innerHTML = data.result[3].twod;
    ...
    const fetchYesterdayLive = () => {
        const apiUrl = "https://www.twodthailandmyanmar.com/api/live/yesterday";
        fetch(apiUrl,{
                method: 'GET',
                headers: {
                    accept: 'application/json',
...
<?php /**PATH /var/www/vhosts/twodthailandmyanmar.com/httpdocs/resources/views/livetwo.blade.php ENDPATH**/ ?>